...
namespace backend.Data
{
    public class FileUploadScreenContext
    {
        ...
        private List<string> GetFileParameterList(string fileParameters)
        {
            return fileParameters.Split("|");
        }
        //function wil execute the sql query to check whether the fie exists in the database
        public bool FileStatus(string fileParameters)
        {
            var status = true;
            var FileParameter = GetFileParameterList(fileParameters);
        ...
        // function tha will return tha data retrieved from database
        public IList<FileModel> retrieveFilesInDb()
        {
            string cs = @"server=localhost;userid=root;password=fathimaadmin;database=DOCUMENT_MANAGEMENT";
        ...
        public string fileSavetoDb(FileModel model, IWebHostEnvironment environment)
        {
        ...
        //function that will map the taining and company name  to the corresponding id 
        //and execute the query  delete the file with from  trainingdetails_data database
        public string fileDeletefromDb(string file)
        {
        ...
        //private function that maps company id to the name 
        ...
        //private function that maps training id to the name 
        ...
        //function that will execute the sql query to return all available files in the database
