ngOnInit() {
    this.setDefaultTemperatureData();
    this.setDefaultPressureData();
    this.setDefaultModeTimeData();
    this.setDefaultFlowData();
    this.setDefaultDetectorData();
    this.getDriftLimits();
    this.fixPrecisionToData();
    this.getModeDataValuesAPI();
    this.setFurnaceData();
    this.setFlowControllerData();
    this.setDetectorData();
    this.setPressureData();
    this.getMaintenanceInfoAPI();    
    this.setMode();
}

setDefaultTemperatureData() {
